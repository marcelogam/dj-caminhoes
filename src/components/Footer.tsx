...
export default function Footer() {
  return (
    <footer id="footer" className="bg-dark-light border-t border-dark-border">
      {/* CTA Band */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3 text-white">
            ...
            <div>
              ...
              <p className="text-sm text-white/80">Entre em contato e faça seu orçamento sem compromisso</p>
            </div>
          </div>
          <Link
            to="/contato"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-xl font-display font-bold text-white">DJ</span>
                <span className="block text-xs text-light-muted tracking-widest uppercase -mt-1">Caminhões</span>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              <a href="#" className="w-10 h-10 rounded-xl bg-dark flex items-center justify-center text-light-muted hover:text-primary hover:bg-primary/10 transition-all border border-dark-border">
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.path}>
                  <Link
                    to={link.path}
                    className="flex items-center gap-2 text-sm text-light-muted hover:text-primary transition-colors group"
                  >
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-sm text-light-muted">
                <MapPin size={18} className="text-primary shrink-0 mt-0.5" />
                <span>Av. Brasil, 1500 - São Paulo, SP</span>
              </li>
              <li>
                <a href="tel:+5511999999999" className="flex items-center gap-3 text-sm text-light-muted hover:text-primary transition-colors">
                  <Phone size={18} className="text-primary shrink-0" />
                  (11) 99999-9999
                </a>
              </li>
              <li>
                <a href="mailto:contato@djcaminhoes.com.br" className="flex items-center gap-3 text-sm text-light-muted hover:text-primary transition-colors">
          ...
          {/* Horário */}
          <div>
            <h4 className="text-white font-display font-semibold mb-6">Horário</h4>
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-sm text-light-muted">
