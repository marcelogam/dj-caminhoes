...
import heroImg from '../assets/images/hero-truck.png';
...
export default function Home() {
  return (
    <main className="bg-dark min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
          <div className="max-w-2xl">
            <div className="animate-fade-in-up">
              <span className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 text-primary px-4 py-1.5 rounded-full text-xs font-semibold tracking-wider uppercase mb-6">
                <Star size={14} className="fill-primary" />
                Referência em Caminhões
              </span>
            </div>

            <h1 className="animate-fade-in-up delay-100 text-4xl sm:text-5xl lg:text-7xl font-display font-black text-white leading-[1.1] mb-6">
              Seu Próximo{' '}
              <span className="text-gradient-red">Caminhão</span>{' '}
              Está Aqui
            </h1>

            <p className="animate-fade-in-up delay-200 text-lg text-light-muted max-w-lg mb-10 leading-relaxed">
            ...
            <div className="animate-fade-in-up delay-300 flex flex-col sm:flex-row gap-4">
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 glass text-white px-8 py-4 rounded-2xl font-bold text-base transition-all duration-300 hover:bg-white/10 hover:-translate-y-1"
              >
      ...
      {/* ========== STATS ========== */}
      <section id="stats" className="relative py-20 border-y border-dark-border bg-dark-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, i) => (
              <AnimatedSection key={stat.label} className={`text-center delay-${(i + 1) * 100}`}>
                <p className="text-3xl sm:text-4xl lg:text-5xl font-display font-black text-gradient-red mb-2">
                  {stat.value}
                </p>
      ...
      {/* ========== FEATURED TRUCKS ========== */}
      <section id="featured-trucks" className="py-24 bg-dark">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-display font-black text-white mb-4">
              Caminhões em <span className="text-gradient-red">Destaque</span>
            </h2>
                ...
                >
                  ...
                  <div className="p-5 space-y-3">
                    ...
                    <div className="pt-3 border-t border-dark-border flex items-center justify-between">
                      ...
                      <span className="text-light-muted group-hover:text-primary transition-colors">
      ...
      {/* ========== SERVICES ========== */}
      <section id="services" className="py-24 bg-dark-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <AnimatedSection animation="animate-slide-left">
                ...
                <h2 className="text-3xl sm:text-4xl font-display font-black text-white mb-6">
                  Mais do que Vender,{' '}
                  <span className="text-gradient-red">Cuidamos de Tudo</span>
                </h2>
                <p className="text-light-muted mb-10 leading-relaxed">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {services.map((service, i) => (
                  <AnimatedSection key={service.title} className={`delay-${(i + 1) * 100}`} animation="animate-fade-in-up">
                    <div className="group p-5 rounded-2xl bg-dark border border-dark-border hover:border-primary/30 transition-all duration-300 hover:-translate-y-1">
                      <div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center mb-3 group-hover:bg-primary/20 transition-colors">
                        <service.icon size={20} className="text-primary" />
                      </div>
                      <h4 className="text-white font-semibold mb-1">{service.title}</h4>
                      <p className="text-xs text-light-muted leading-relaxed">{service.desc}</p>
                    </div>
                  </AnimatedSection>
                ))}
              </div>
            ...
            <AnimatedSection animation="animate-slide-right">
              <div className="relative">
                ...
                <div className="absolute -bottom-6 -left-6 bg-primary text-white p-6 rounded-2xl shadow-xl">
                  ...
                  <p className="text-sm text-white/80">Inspecionados</p>
                </div>
              </div>
            </AnimatedSection>
          </div>
      ...
      <section id="why-us" className="py-24 bg-dark relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <AnimatedSection className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-display font-black text-white mb-4">
              A <span className="text-gradient-red">Confiança</span> que Você Precisa
            </h2>
          </AnimatedSection>
            ...
            <div className="space-y-6">
              {[
                ...
                <AnimatedSection key={item.title} className={`delay-${(i + 1) * 100}`} animation="animate-fade-in-up">
                  <div className="flex gap-4 p-5 rounded-2xl bg-dark-card border border-dark-border hover:border-primary/30 transition-all group">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-light-muted leading-relaxed">{item.desc}</p>
                    </div>
                  </div>
                </AnimatedSection>
              ))}
          ...
          <AnimatedSection>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                to="/contato"
                id="cta-contato"
                className="border-2 border-white text-white font-bold px-8 py-4 rounded-2xl hover:bg-white/10 transition-all duration-300 hover:-translate-y-1"
              >
                Falar com Consultor
              </Link>
            </div>
