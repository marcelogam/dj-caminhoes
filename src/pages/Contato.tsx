        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {contactInfo.map((info, i) => (
            <AnimatedSection key={info.label} className={`delay-${(i + 1) * 100}`}>
              <a
                href={info.href}
                className="group block p-6 rounded-2xl bg-white border border-slate-200 hover:border-primary/30 transition-all duration-300 hover:-translate-y-1 text-center"
              >
                <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center mx-auto mb-4 group-hover:bg-primary/20 transition-colors">
                  <info.icon size={22} className="text-primary" />
                </div>
                <h3 className="text-slate-900 font-semibold mb-1">{info.label}</h3>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <AnimatedSection animation="animate-slide-left">
            <div className="p-8 rounded-3xl bg-white border border-slate-200">
              <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                  <h2 className="text-xl font-display font-bold text-slate-900">Envie uma Mensagem</h2>
                  <p className="text-sm text-slate-500">Responderemos o mais rápido possível</p>
                </div>
              </div>
              ...
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-3.5 bg-white border border-slate-200 rounded-xl text-slate-900 placeholder-light-dim focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/30 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                  />
                </div>
                ...
                <textarea
                  ...
                  disabled={status === 'loading'}
                  className="w-full px-4 py-3.5 bg-white border border-slate-200 rounded-xl text-slate-900 placeholder-light-dim focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/30 transition-all resize-none disabled:opacity-50 disabled:cursor-not-allowed"
                />
          ...
          <AnimatedSection animation="animate-slide-right">
            <div className="h-full min-h-[500px] rounded-3xl overflow-hidden border border-slate-200 relative">
              <iframe
                title="Localização DJ Caminhões"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d59996.3380829994!2d-44.037168600488286!3d-19.976125112628736!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xa6bf001e1540df%3A0x975b4585a00664fe!2sDJ%20CAMINH%C3%95ES!5e0!3m2!1spt-BR!2sbr!4v1776911422273!5m2!1spt-BR!2sbr"
                width="100%"
                height="100%"
